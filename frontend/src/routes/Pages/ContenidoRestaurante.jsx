...
function ContenidoRestaurante() {
    ...
    const pagarEnLocal = async () => {
        ...
        try {
            const ok = await confirmarReserva('local');
            if (ok) {
    ...
    const procesarTarjeta = async () => {
        ...
        try {
            const ok = await confirmarReserva('tarjeta');
            if (ok) {
                setModalPago(false);
                        ...
                        <div className="cr-campos">
                            <div className="cr-campo">
                                ...
                                <div className="cr-campo-wrap">
                                    ...
                                    <input type="date" className="cr-campo-input" value={fecha} onChange={e => setFecha(e.target.value)} />
                                </div>
                            </div>
                            <div className="cr-campo">
                                ...
                                <div className="cr-campo-wrap">
                                    ...
                                    <input type="time" className="cr-campo-input" value={hora} onChange={e => setHora(e.target.value)} />
                                </div>
                            </div>
                            <div className="cr-campo">
                                ...
                                <div className="cr-campo-wrap">
                                    ...
                                    <select className="cr-campo-input" value={personas} onChange={e => setPersonas(e.target.value)}>
