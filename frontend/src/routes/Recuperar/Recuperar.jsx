    ...
    <div className="login-contenedor">
      <div className="login-branding">
        ...
        <div className="beneficios">
          <div className="beneficio-item"><span>1</span> Ingresa tu correo y la nueva contraseña</div>
          <div className="beneficio-item"><span>2</span> Confirma el cambio desde tu correo</div>
